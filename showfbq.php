...
class Feedback_view {
    ...
    public function printar () {
        ...
        $output .= html_writer::tag('th', get_string('name', 'local_survey_intelligence'), ['class' => 'col-3 pl-4']);
        $output .= html_writer::tag('th', get_string('discussion', 'local_survey_intelligence'), ['class' => 'col-4 pl-4']);
        $output .= html_writer::start_tag('th', ['class' => 'col-3 pl-4']);
        $output .= html_writer::tag('span', get_string('polarity', 'local_survey_intelligence').' / ');
        $output .= html_writer::tag('span', get_string('language', 'local_survey_intelligence'));
        ...
        foreach ($posts as $key => $value) {
            ...
            if (is_object($name)) {
                ...
                $output .= html_writer::tag('a', get_string('notFound', 'local_survey_intelligence'), ['class' => 'col-3' ]);
            }
